        ...
        <section className="relative bg-cover bg-blue-100 h-[70vh] flex items-center justify-center px-6 ">
            <div className="bg-white p-5 sm:p-8 max-w-2xl text-center shadow-lg">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
                    Welcome to HabitHub – Your Personal Habit Tracker
                </h1>
                ...
                <p className="mt-6 text-xs sm:text-sm md:text-base">
                    Take control of your daily routines and reach your goals
                    with ease. HabitHub helps you track your habits, stay
                    consistent, and share progress with friends for motivation.
                </p>
            </div>
        </section>
    )
