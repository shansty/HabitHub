...
const HabitScheduleDropdown: React.FC<HabitScheduleDropdownProps> = ({
    setFormData,
    habitSchedule,
}) => {
        ...
        <DropdownMenu.Root modal={false}>
            ...
            >
                ...
                <DropdownMenu.Sub>
                    <DropdownMenu.SubTrigger
                        onMouseEnter={() =>
                            setSelectedSchedule(Schedule.MONTHLY)
                        }
